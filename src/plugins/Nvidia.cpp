...
std::vector<TreeNode<DeviceNode>> getMemClockWrite(NvidiaGPUData data) {
	...
	Range<int> range{
	    static_cast<int>(values.u.range.min / 2), static_cast<int>(values.u.range.max / 2)};
...
std::vector<TreeNode<DeviceNode>> getCoreClockWrite(NvidiaGPUData data) {
	...
	Range<int> range{
	    static_cast<int>(values.u.range.min), static_cast<int>(values.u.range.max)};
...
std::vector<TreeNode<DeviceNode>> getVoltageOffset(NvidiaGPUData data) {
	...
	// uV -> mV
	Range<int> range{static_cast<int>(values.u.range.min / 1000),
	    static_cast<int>(values.u.range.max / 1000)};
