...
public:
    ...
    QString nvCoreClkQ = "nvidia-smi --query-gpu=clocks.gr --format=csv,noheader";
    QString nvMemClkQ = "nvidia-smi --query-gpu=clocks.mem --format=csv,noheader";
    QString nvCoreUtilQ = "nvidia-smi --query-gpu=utilization.gpu --format=csv,noheader";
